...
interface DeviceRepository
{
     ...
     * @return mixed
     */
    public function addLocationOfDevice($token);
    public function get_active_devices($userId);
    public function get_deactive_devices($userId);
    public function get_device_number($userId);
