			...
			@permission('manage.companies')
                <li class="nav-item">
					<a class="nav-link {{ Request::is('company*') ? 'active' : ''  }}" href="{{ route('company.index') }}">
                        ...
                        <i class="fa fa-building fa-fw"></i><span> @lang('app.companies') </span>
                    </a>
                </li>
            @endpermission
			@permission('devices')
				<li class="nav-item">
					<a class="nav-link {{ Request::is('device*') ? 'active' : ''  }}" href="{{ route('device.index') }}">
                        <i class="fa fa-mobile fa-fw"></i> @lang('app.devices')
                    </a>
                </li>
            @endpermission
			@permission('Transactions')
				<li class="nav-item">
					<a class="nav-link {{ Request::is('transaction*') ? 'active' : ''  }}" href="{{ route('transaction.index') }}">      
                        <i class="fa fa-mobile fa-fw"></i> @lang('app.transactions')
                    </a>
                </li>
            @endpermission
