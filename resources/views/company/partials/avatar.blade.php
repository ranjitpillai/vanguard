<div class="panel panel-default">
    <div class="panel-heading">@lang('app.company_logo')</div>
    <div class="panel-body avatar-wrapper">
        ...
        <div id="avatar"></div>
        <div>
            <img class="avatar avatar-preview img-circle" src="{{ $edit ? url('upload/companies/'.$company->avatar) : url('assets/img/profile.png') }}">
